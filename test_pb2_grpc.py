...
class TestStub(object):
    ...
    def __init__(self, channel):
        ...
        self.getMessage = channel.unary_unary(
                ...
                response_deserializer=test__pb2.ResponsePayload.FromString,
...
def add_TestServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'getMessage': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=test__pb2.ResponsePayload.SerializeToString,
            ),
    }
...
class Test(object):
    ...
    def getMessage(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            test__pb2.ResponsePayload.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
